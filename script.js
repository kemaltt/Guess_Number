    ...
    if (val < 1 || val > 100) {
        ...
        if (sayac > 0) {
            ...
            if (val < guessNumber) {
                ...
                document.querySelector(".container").innerHTML = "<h1 style='color: greenyellow;'>You won it!</h1> <br> <p>The number was:</p> " + guessNumber + "<br><br> <a style='color: greenyellow;' href='./index.html'> Try it again</a>"
